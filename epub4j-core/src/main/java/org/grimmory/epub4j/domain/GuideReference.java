...
public class GuideReference extends TitledResourceReference {
  ...
  @Serial private static final long serialVersionUID = -316179702440631834L;
  ...
  /**
   * an epigraph is a phrase, quotation, or poem that is set at the beginning of a document or
   * component.
   *
   * <p>source: http://en.wikipedia.org/wiki/Epigraph_%28literature%29
   */

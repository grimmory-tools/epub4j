 ...
 *
 * <p>This contrasts with the Table of Contents sections which is an index into the Book's sections.
 *
 * @see TableOfContents
 * @author paul
 */
public class Spine implements Serializable {
  ...
  public void addResource(Resource resource) {
    addSpineReference(new SpineReference(resource));
  }
   ...
   * Contents. The epubwriter will look for it here first, followed by some clever tricks to find it
   * elsewhere if not found. Put it here to be sure of the expected behaviours.
   *
   * @param tocResource
   */
  ...
  /**
   * The resource containing the XML for the tableOfContents. When saving an epub file this resource

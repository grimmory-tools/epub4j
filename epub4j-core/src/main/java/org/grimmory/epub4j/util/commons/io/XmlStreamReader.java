package org.grimmory.epub4j.util.commons.io;
...
public class XmlStreamReader extends Reader {
  ...
  public XmlStreamReader(
      InputStream is, String httpContentType, boolean lenient, String defaultEncoding)
      throws IOException {
    this.defaultEncoding = defaultEncoding;
    try {
      BOMInputStream bom =
  ...
  private String doHttpStream(
      BOMInputStream bom, BOMInputStream pis, String httpContentType, boolean lenient)
      throws IOException {
    String bomEnc = bom.getBOMCharsetName();
    String xmlGuessEnc = pis.getBOMCharsetName();
    String xmlEnc = getXmlProlog(pis, xmlGuessEnc);
  ...
  String calculateRawEncoding(String bomEnc, String xmlGuessEnc, String xmlEnc) throws IOException {
    ...
    if (UTF_16BE.equals(bomEnc) || UTF_16LE.equals(bomEnc)) {
  ...
  String calculateHttpEncoding(
      String httpContentType, String bomEnc, String xmlGuessEnc, String xmlEnc, boolean lenient)
      throws IOException {
    ...
    if (UTF_16BE.equals(cTEnc) || UTF_16LE.equals(cTEnc)) {
      if (bomEnc != null) {

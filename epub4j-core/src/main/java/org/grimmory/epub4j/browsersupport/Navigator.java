 ...
 *
 * <p>It helps moving from one resource to the other, from one resource to the other and keeping
 * other elements of the application up-to-date by calling the NavigationEventListeners.
 *
 * @author paul
 */
public class Navigator implements Serializable {

  @Serial private static final long serialVersionUID = 1076126986424925474L;
  private Book book;
  ...
  public void gotoFirstSpineSection(Object source) {
    gotoSpineSection(0, source);
  }

  public void gotoPreviousSpineSection(Object source) {
    gotoPreviousSpineSection(0, source);
  }
  ...
  public void gotoNextSpineSection(Object source) {
    if (currentSpinePos < 0) {
      gotoSpineSection(0, source);
    } else {
  ...
  public void gotoResource(Resource resource, String fragmentId, Object source) {
    gotoResource(resource, 0, fragmentId, source);
  }

  public void gotoResource(Resource resource, int pagePos, Object source) {
  ...
  public void gotoLastSpineSection(Object source) {
    gotoSpineSection(book.getSpine().size() - 1, source);
  }
   ...
   *
   * <p>If you want the eventListeners called use gotoSection(index);
   *
   * @param currentIndex
   */

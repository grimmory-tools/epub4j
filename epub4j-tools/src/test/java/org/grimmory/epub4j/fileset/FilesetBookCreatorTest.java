...
public class FilesetBookCreatorTest {
  ...
  private void copyResourceToFileObject(
      String resourceUrl, FileObject targetDir, String targetFilename) throws IOException {
  ...
  private static void copyInputStreamToFileObject(
      InputStream inputStream, FileObject targetDir, String targetFilename) throws IOException {
